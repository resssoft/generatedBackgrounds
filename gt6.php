...
function drawLine(context, x1, y1, x2, y2, lineWidth, r, g, b, a) {
   context.save();
   context.beginPath();
   context.lineWidth = lineWidth;
...
function drawSoftCircle(context, centerX, centerY, radius, lineWidth, r, g, b, a, fillit) {
   context.beginPath();
...
<?php } ?>
    ...
    context.strokeStyle  = 'rgba(127,127,1278,1.0)';
    context.fill();

    var rows = getRandomInt(0, 150);
    var x=0,y=0;

    x = getRandomInt(10, 1400);
    y = getRandomInt(10, 650);
    for (var i = 0; i < rows; i++) {
        x1 = getRandomInt(0, 1400);
        y1 = getRandomInt(0, 700);

        drawLine(context, x, y, x1, y1, 1, 250, 250, 250, 1);//drawSoftLine
        drawSoftCircle(context, x1, y1, 4, 1, 250, 250, 250, 1, 0);
